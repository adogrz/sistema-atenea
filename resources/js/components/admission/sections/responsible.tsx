    ...
    return (
        <Card>
            <CardHeader>
                ...
                <p className="text-sm text-muted-foreground">A continuación se solicitan los datos del responsable del aspirante</p>
            </CardHeader>
            <CardContent className="space-y-6">
                ...
                <div className="space-y-6">
                    ...
                    {/* Información del responsable 2 (opcional) */}
                    <h4 className="text-base font-medium">Información del segundo responsable (Opcional)</h4>
