...
import { Users, Percent, BarChart, Award } from 'lucide-react';
...
export const StatsCards: React.FC<StatsCardsProps> = ({ participantCount, approvalRate, averageScore, classifiedCount }) => {
    return (
