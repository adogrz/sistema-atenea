...
export default function CreateEvaluation() {
    ...
    useEffect(() => {
        ...
        if (!data.nombre) {
            newErrors.nombre = 'El nombre de la evaluación es requerido';
        }
    ...
    }, [data.nombre, data.peso_porcentual, data.nota_maxima, data.fecha_inicio, data.fecha_fin, data.permite_credito_extra, data.credito_extra_max]);
                                        ...
                                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                            <div className="space-y-2">
                                                ...
                                                <Input
                                                    ...
                                                    placeholder="Ej: 30"
                                                />
                                                {validationErrors.peso_porcentual && (
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <Switch
                                                ...
                                                onCheckedChange={(value) => {
                                                    setData('permite_credito_extra', value as false);
                                                    if (!value) {
                                                        setData('credito_extra_max', '0');
                                                    }
                                                }}
                                            />
                                        </div>
                                        ...
                                        {data.permite_credito_extra && (
                                            <div className="space-y-2 pt-4">
                                                ...
                                                <Input
                                                    ...
                                                    placeholder="Ej: 1.0"
                                                />
                                                {validationErrors.credito_extra_max && (
                                                    <p className="text-sm text-red-600">
                                                        {validationErrors.credito_extra_max}
                                                    </p>
                                                )}
